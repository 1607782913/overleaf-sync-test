...
Contrastive backdoors poison pre-training data so triggers steer representations to an attacker-chosen target while preserving clean utility \cite{carlini2022poisoning,zhang2024corruptencoder}.
